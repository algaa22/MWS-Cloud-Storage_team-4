...
public class UserController {
  ...
  @Override
  public FullHttpResponse handleJsonRequest(
      ChannelHandlerContext ctx, HttpRequest request, HttpObject msg) {
  ...
  @Override
  protected FullHttpResponse handleGet(HttpRequest request, String url) {
    return null;
  }

  @Override
  protected FullHttpResponse handlePost(HttpRequest request, String url) {
    return null;
  }

  @Override
  protected FullHttpResponse handleUpdate(HttpRequest request, String url) {
    return null;
  }

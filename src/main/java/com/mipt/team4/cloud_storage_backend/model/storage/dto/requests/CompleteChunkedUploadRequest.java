...
@RequestMapping(method = "POST", path = ApiEndpoints.FILES_CHUNKED_UPLOAD_COMPLETE)
public record CompleteChunkedUploadRequest(@UserId UUID userId, @QueryParam UUID sessionId) {}

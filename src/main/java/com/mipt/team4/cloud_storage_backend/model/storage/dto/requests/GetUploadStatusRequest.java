...
@RequestMapping(method = "GET", path = ApiEndpoints.FILES_CHUNKED_UPLOAD_STATUS)
public record GetUploadStatusRequest(@UserId UUID userId, @QueryParam UUID sessionId) {}

...
public abstract class BaseStorageIT extends BaseIT {
    ...
    @Autowired
    protected FileSimpleTransferITUtils transferITUtils;
    @Autowired
    protected FileOperationsITUtils operationsITUtils;
    @Autowired
    protected UserAuthUtils userAuthUtils;
    @Autowired
    protected ITUtils itUtils;

...
public class UserSmokeTest extends BaseUserE2ETest {
  ...
  public void shouldLoginUser() throws IOException, InterruptedException {
    ...
    HttpResponse<String> response = UserTestUtils.sendLoginRequest(client, testEmail, testPassword);
  ...
  public void shouldNotLoginWithWrongPassword() throws IOException, InterruptedException {
    ...
    HttpResponse<String> response =
        UserTestUtils.sendLoginRequest(client, testEmail, "wrong_password");
  ...
  public void shouldGetUserInfo() throws IOException, InterruptedException {
    ...
    HttpResponse<String> response = UserTestUtils.sendUserInfoRequest(client, accessToken);
  ...
  public void shouldLogoutUser() throws IOException, InterruptedException {
    ...
    HttpResponse<String> logoutResponse = UserTestUtils.sendLogoutRequest(client, accessToken);

    assertEquals(HttpStatus.SC_OK, logoutResponse.statusCode());

    HttpResponse<String> infoResponse = UserTestUtils.sendUserInfoRequest(client, accessToken);
